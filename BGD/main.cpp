// Docker random container name generator:
...
const string leftSide[leftLength] = {
    "admiring",
    "adoring",
    "affectionate",
    "agitated",
...
const string rightSide[rightLength] = {
...
int main()
{
    ...
    {
        string name = leftSide[rand() % leftLength] + "_" + rightSide[rand() % rightLength];
        while (name == "boring_wozniak") /* Steve Wozniak is not boring */
        {
            name = leftSide[rand() % leftLength] + "_" + rightSide[rand() % rightLength];
        };
